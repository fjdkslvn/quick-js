...
const ThemeSelector: React.FC = () => {
  ...
  return (
    <div className="relative">
        ...
        {themeToggle &&
          <div ref={themeSelectorRef} className="absolute top-16 right-4 w-28 bg-white shadow-lg py-1 rounded-md border-solid border border-gray-300 text-gray-900 font-medium text-sm dark:text-gray-100 dark:bg-backDarkColor">
