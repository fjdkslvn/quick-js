...
const DataInput: React.FC<{ dataType: DataSelectorType }> = ({ dataType }) => {
  ...
  return (
    <div className="relative">
      ...
      />
      <RestartAltIcon className={["cursor-pointer absolute right-2 bottom-4", resetActive ? "text-rose-400 dark:text-rose-400" : "text-gray-600 dark:text-gray-300"].join(' ')} onClick={resetData}/>
    </div>
  );
};
