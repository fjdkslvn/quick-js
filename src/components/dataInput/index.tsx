...
const DataInput: React.FC<{ dataType: DataSelectorType }> = ({ dataType }) => {
  ...
  return (
    <div className="relative">
      ...
      />
      <RestartAltIcon className={["cursor-pointer absolute right-2 bottom-4 text-gray-600 dark:text-gray-300", resetActive && "text-pink-600 dark:text-pink-600"].join(' ')} onClick={resetData}/>
    </div>
  );
};
